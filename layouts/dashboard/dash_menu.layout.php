...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            <li>
                <a href="<?php echo BASE_URL . '/views/admin/dashboard'?>">
                    <i class="flaticon-025-dashboard"></i>
                    <span class="nav-text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL . '/views/admin/departments'?>">
                    <i class="flaticon-381-umbrella"></i>
                    <span class="nav-text">Departments</span>
                </a>
            </li>
            <li>
                <a href="<?php echo BASE_URL . '/views/admin/classes'?>">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo BASE_URL . '/views/admin/users/add-user'?>">Add New</a></li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo BASE_URL . '/views/admin/permissions/add-permission'?>">Add New</a></li>
                    <li><a href="#">View Users</a></li>
                </ul>
            </li>
