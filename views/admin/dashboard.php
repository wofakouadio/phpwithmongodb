<?php require_once "../../layouts/dashboard/dash_header.layout.php"; ?>

  <?php require_once "../../layouts/dashboard/dash_preloader.layout.php"; ?>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        <?php require_once "../../layouts/dashboard/dash_nav.layout.php"; ?>
        <!--**********************************
            Nav header end
        ***********************************-->
            ...
            Chat box start
        ***********************************-->
          <?php require_once "../../layouts/dashboard/dash_chats.layout.php" ?>
		    <!--**********************************
            Chat box End
        ***********************************-->
            ...
            Header start
        ***********************************-->
          <?php require_once "../../layouts/dashboard/dash_heading.layout.php"; ?>
        <!--**********************************
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        <?php require_once "../../layouts/dashboard/dash_menu.layout.php"; ?>
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
          <?php require_once "../../layouts/dashboard/dash_version_control.layout.php"; ?>
        <!--**********************************
            Footer end
        ***********************************-->
    ...
    ***********************************-->
	 <!-- Modal -->
    <?php require_once "../../layouts/dashboard/dash_modals.layout.php"; ?>
	
<?php require_once "../../layouts/dashboard/dash_footer.layout.php"; ?>

<!-- <script>
    $(document).ready(()=>{
      let page_title = location.pathname.split("/").slice(-1);
      let page_title_placeholder = $("#page_title").val(location.pathname.split("/").slice(-1))
        console(location.pathname.split("/").slice(-1));
    })
</script> -->