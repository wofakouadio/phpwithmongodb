...
<?php require_once BASE_URL."/layouts/dashboard/dash_header.layout.php"; ?>
  ...
  <?php require_once BASE_URL."/layouts/dashboard/dash_preloader.layout.php"; ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-rounded btn-secondary" data-bs-toggle="modal" data-bs-target=".new-department-modal">
    ...
    ***********************************-->
	 <!-- Modal -->
    <?php require_once BASE_URL."/views/admin/modals/departments-modals.php"; ?>
	
<?php require_once BASE_URL."/layouts/dashboard/dash_footer.layout.php"; ?>

<!-- departments scripts -->
<script src="<?php echo BASE_URL.'/models/department/js/departments_script.js'; ?>" ></script>
<!-- department datatables -->
<script src="<?php echo BASE_URL.'/models/department/js/departments_datatables.js'; ?>" ></script>